(function () {
    ...
    function Class(parent, methods) {
        var id = ++nextid, realName, Class, current, i, privateMethods = {}, staticMethods = {}, abstractMethods = {}, finalMethods = {}, declaredMethods = {}, hasAbstract = false, parts;
        if (!methods) {
            methods = parent;
            parent = null;
        }
            ...
            if (parts.length > 1) {
                ...
                switch (parts[0]) {
                    ...
                    case 'abstract':
                        ...
                        break;
                    case 'static':
                        staticMethods[realName] = methods[i];
                        delete methods[i];
                        break;
                    case 'final':
        ...
        for (i in methods) {
            ...
            Class.prototype[i].origin = Class;
        }

        for (i in privateMethods) {
            privateMethods[i].origin = Class;
        }
